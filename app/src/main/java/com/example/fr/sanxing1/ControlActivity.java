...
//    private MyHandler mHandler1;
    ...
    private String PLC_B_ATUO_ON = "MCMD@0101";
    private String PLC_B_FS1_ON = "MCMD@0103";
    private String PLC_B_FS1_OFF = "MCMD@0104";
    private String PLC_B_FS2_ON = "MCMD@0105";
    private String PLC_B_FS2_OFF = "MCMD@0106";
    private String PLC_B_QN_ON = "MCMD@0107";
    private String PLC_B_QN_OFF = "MCMD@0108";
...
//            });
    ...
    private View.OnClickListener clickListener_cam = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            show_img_bn_layout.setSelected(false);
            Intent intent = new Intent();
            intent.setClass(ControlActivity.this, AutocmdActivity.class);
            startActivity(intent);
            overridePendingTransition(R.anim.zoommin, R.anim.zoomout);
            finish();
        }
